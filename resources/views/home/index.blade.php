...
<div id="page-container" class="fade">
    ...
    <div id="service" class="content" data-scrollview="true">
        ...
        <div class="container">
            ...
            <p class="content-desc">
                Out detail specialist are top notch, some of the services we offer are listed below. Don't see what you are looking for create an account today and search all the services available to you.
            </p>
            <!-- begin row -->
            <div class="row">
                <!-- begin col-4 -->
