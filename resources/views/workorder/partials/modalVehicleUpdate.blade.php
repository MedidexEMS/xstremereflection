        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                @if(!$workOrder->estimate->vehicle)
                    <form action="/estimate/addVehicle/{{$workOrder->estimate->customer->id}}/{{$workOrder->estimate->id}}" method="POST">
                        @csrf
                        <div class="form-group mb-2">
                            ...
                            <select class="js-example-basic-single" name="vehicleId" id="vehicleId" style="width:100%" onchange="vehicleUpdate()">
                                ...
                                @foreach($workOrder->estimate->customer->vehicles as $vehicle)
                    ...
                    <form id="newVehicleForm" action="/estimate/addVehicle/{{$workOrder->estimate->customer->id}}/{{$workOrder->estimate->id}}" method="POST">
                        @csrf
                        <div class="form-group mb-2">
