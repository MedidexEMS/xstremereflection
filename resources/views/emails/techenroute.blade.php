...
<div class="row">
    <div class="col-xl-12 text-center">
        <img src="/assets/img/Logo1.png" width="400px" height="100px" alt="XtremeReflectionLog">
    </div>
    <div class="col-xl-12 text-center">
        <img src="/assets/img/systemxlogo.png" width="400px" height="100px" alt="SystemXLogo">
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-xl-12 text-center">
        <img src="/assets/img/systemxtrmess.png" alt="SystemXLogo">
    </div>

</div>
<div class="row">
    <div class="col-xl-4">
        <img src="/assets/img/seadoo.png" width="200px" height="200px" alt="SystemXLogo">
    </div>
    <div class="col-xl-4">
        <img src="/assets/img/plane.png" width="200px" height="200px" alt="SystemXLogo">
    </div>
    <div class="col-xl-4">
        <img src="/assets/img/rims.png" width="200px" height="200px" alt="SystemXLogo">
    </div>
</div>
<div class="row">
    <div class="col-xl-12 text-center">
        <img src="/assets/img/systemx2.png" alt="SystemXLogo">
    </div>
    <div class="col-xl-12 text-center">
